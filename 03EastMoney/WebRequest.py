...
class WebRequest(object):
    ...
    # @property
    # def proxy(self):
    #     http = requests.get("http://127.0.0.1:5010/get/").content.decode('utf-8')
    #     return {"http": "http://{}".format(http)}

    def get(self, url, params=None, header=None, proxies=None, retry_time=5, timeout=30,
        ...
        while True:
            try:
                html = requests.get(url, params=params, headers=headers, proxies=proxies, timeout=timeout)
